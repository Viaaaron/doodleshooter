...
export class Katana extends ViewModel {
  constructor(ctx) {
    super(ctx); this.name = 'Katana'; this.hint = 'Slash · aim to block and return bullets'; this.kind = 'katana';

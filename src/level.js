...
export const LEVELS = [{ key: 'district', name: 'Doodle District', blurb: 'Streets and rooftops' }, ...(MEXICO_READY ? [{ key: 'mexico', name: 'Doodle Mexico', blurb: 'Sunlit plazas and rooftops' }] : [])];
